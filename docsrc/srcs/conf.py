...
#templates_path = [mayaconf.get_std_template_path()]
...
latex_documents = [
    (master_doc, 'cymel.tex', u'cymel Documentation',
     u'ryusas', 'manual'),
]
...
man_pages = [
    (master_doc, 'cymel', u'cymel Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'cymel', u'cymel Documentation',
     author, 'cymel', 'One line description of project.',
     'Miscellaneous'),
]
